...
#define MASTERNODE_COLLATERAL                  1500
...
//
// The Masternode Class. For managing the darksend process.
// It contains the input of the MONK collateral, signature to prove
