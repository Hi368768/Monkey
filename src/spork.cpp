...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID))
        ...
        if (nSporkID == SPORK_1_ENABLE_MASTERNODE_PAYMENTS) r = SPORK_1_ENABLE_MASTERNODE_PAYMENTS_DEFAULT;
        ...
        if (nSporkID == SPORK_11_MN_WINNER_MINIMUM_AGE) r = SPORK_11_MN_WINNER_MINIMUM_AGE_DEFAULT;
...
{
    if (strName == "SPORK_1_ENABLE_MASTERNODE_PAYMENTS") return SPORK_1_ENABLE_MASTERNODE_PAYMENTS;
    ...
    if (strName == "SPORK_11_MN_WINNER_MINIMUM_AGE") return SPORK_11_MN_WINNER_MINIMUM_AGE;
...
{
    if (id == SPORK_1_ENABLE_MASTERNODE_PAYMENTS) return "SPORK_1_ENABLE_MASTERNODE_PAYMENTS";
    ...
    if (id == SPORK_11_MN_WINNER_MINIMUM_AGE) return "SPORK_11_MN_WINNER_MINIMUM_AGE";
