...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeMonkeyAmount"))
        settings.setValue("nAnonymizeMonkeyAmount", 1000);
    nAnonymizeMonkeyAmount = settings.value("nAnonymizeMonkeyAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeMonkeyAmount:
            return QVariant(nAnonymizeMonkeyAmount);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeMonkeyAmount:
            nAnonymizeMonkeyAmount = value.toInt();
            settings.setValue("nAnonymizeMonkeyAmount", nAnonymizeMonkeyAmount);
            emit AnonymizeMonkeyAmountChanged(nAnonymizeMonkeyAmount);
            break;
        default:
            break;
        }
