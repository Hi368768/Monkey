...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelAnonymized->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, BitcoinUnits::separatorNever));
...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeMonkeyAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeMonkeyAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeMonkeyAmount = strAnonymizeMonkeyAmount.remove(strAnonymizeMonkeyAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeMonkeyAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    ...
    if (nMaxToAnonymize > nAnonymizeMonkeyAmount * COIN) nMaxToAnonymize = nAnonymizeMonkeyAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeMonkeyAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                          .arg(strAnonymizeMonkeyAmount));
        strAnonymizeMonkeyAmount = strAnonymizeMonkeyAmount.remove(strAnonymizeMonkeyAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeMonkeyAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
