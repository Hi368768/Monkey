...
void BitcoinGUI::createActions()
{
    ...
    if (!fLiteMode && IsSporkActive(SPORK_1_ENABLE_MASTERNODE_PAYMENTS)) {
    ...
    #ifdef Q_OS_MAC
        masternodeManagerAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_6));
    #else
